...
export async function createUser(body: API.UserAddRequest, options?: { [key: string]: any }) {
...
export async function listUser(body: API.UserQueryRequest, options?: { [key: string]: any }) {
